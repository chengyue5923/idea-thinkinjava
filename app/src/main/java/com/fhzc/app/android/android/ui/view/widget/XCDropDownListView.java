...
public class XCDropDownListView extends LinearLayout{
	...
	public void initView(){
		...
		this.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(popupWindow == null ){
					imageView.setImageDrawable(getResources().getDrawable(R.drawable.dropwindow_up));
					showPopWindow();
				}else{
					imageView.setImageDrawable(getResources().getDrawable(R.drawable.dropwindow_down));
					closePopWindow();
				}
			}
		});
	...
	public void setItemsData(ArrayList<String> list){
		...
		textReturn=list.get(0).toString();
	}
	/**
	 * 数据适配器
	 * @author caizhiming
