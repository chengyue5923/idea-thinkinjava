package com.fhzc.app.android.android.service;
...
import com.fhzc.app.android.android.ui.view.widget.DataCleanManager;
...
public class UpdateService extends Service {
    ...
    private String saveFileName = Constant.APK_DOWNLOAD_PATH + File.separator + "fhzcTemple.apk";
...
//        dao.dropAllTable();
//        DataCleanManager.cleanApplicationData(this,Constant.LOGPATH);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            if (!StringTools.isNullOrEmpty(apkUrl)) {
                ...
                com.base.platform.utils.android.Logger.e("-------apkUrl----local---" + saveFileName);
    ...
    private class DowLoadThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                e.printStackTrace();
                com.base.platform.utils.android.Logger.e(e.getLocalizedMessage(), e);
