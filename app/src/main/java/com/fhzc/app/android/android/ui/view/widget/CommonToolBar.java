...
public class CommonToolBar extends RelativeLayout implements View.OnClickListener {
    ...
    private TextView rightText,finishTextView;
    ...
    public void setCollect(boolean isCollect) {
        imageView.setImageResource(isCollect ? R.drawable.collect_y : R.drawable.collect_n);
        imageView.setTag(isCollect ? "true" : "false");
    }
