...
//		itemView = LayoutInflater.from(context).inflate(R.layout.adapter_cash_back_item, null);
	}
	...
	private boolean canLoad() {
		Logger.e("ddd"+isBottom()+!isLoading+isPullUp());
	...
	private boolean isPullUp() {
		Logger.e(mLastY+"---"+mYDown+"-----"+mTouchSlop+"");
