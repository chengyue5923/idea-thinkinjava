...
public class GridAdapter extends BaseAdapter {
    ...
    public GridAdapter(Context context, List<String> bitmaps) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.bitmaps = bitmaps;
    }

    public GridAdapter(Context context, List<String> bitmaps, int count) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.bitmaps = bitmaps;
        this.count = count;
