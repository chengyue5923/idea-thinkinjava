    ...
    private class CountHandler extends Handler {
        ...
        public void dispatchMessage(Message msg) {
            ...
            if (msg.what == ABLE_STAUES) {
                ...
                setBackgroundResource(R.drawable.forget_password_button_bg);
                setTextColor(getResources().getColor(R.color.appColorBlue));
                setEnabled(true);
