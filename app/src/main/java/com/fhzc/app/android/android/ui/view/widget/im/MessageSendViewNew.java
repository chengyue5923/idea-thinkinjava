...
import com.fhzc.app.android.android.ui.view.adapter.EmojiViewPageAdapter;
...
//            messageEditText.requestFocus();
    ...
    private void switchToolbar() {
        ...
        if (speakBtn.getVisibility() != VISIBLE) {
            ...
            audioBtn.setImageResource(R.drawable.chat_audio);
        } else {
            speakBtn.setVisibility(GONE);
            messageEditText.setVisibility(VISIBLE);
            audioBtn.setImageResource(R.drawable.chat_keybord);
        }
