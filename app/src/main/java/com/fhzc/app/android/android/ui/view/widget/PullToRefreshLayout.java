...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void setNoMoreItem(boolean canUp) {
        this.noMoreItem = canUp;
    }
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case REFRESHING:
                ...
                refreshStateTextView.setText("Don't miss a single chance to save!");
                break;
            ...
            case MotionEvent.ACTION_MOVE:
                if (mEvents == 0) {
                    if (pullDownY > 0
                            ...
                            && canPullDown && state != LOADING && canRefresh)) {
                        // 可以下拉，正在加载时不能下拉
                        // 对实际滑动距离做缩小，造成用力拉的感觉
                        ...
                        if (state == REFRESHING) {
                            ...
                            || (((Pullable) pullableView).canPullUp() && canPullUp && !noMoreItem && state != REFRESHING)) {
                        // 可以上拉，正在刷新时不能上拉
    ...
    class MyTimer {
        ...
        class MyTask extends TimerTask {
            ...
            @Override
            public void run() {
                myHandler.post(new HandlerTask());
            }
