...
public class EditTextMultiLine extends LinearLayout {
    ...
    public EditTextMultiLine(Context context, AttributeSet attrs, int defStyle) {
        ...
        float textSize = attributes.getDimension(R.styleable.EditTextMultiLine_android_textSize, getResources().getDimension(R.dimen.edit_text_content_text_size));
    	/*if(textSize>18){
    		textSize = 18;
    	}*/
...
//    	contentEditText.setTextColor(mcolor);
        ...
        if (maxLength > 0) {
            ...
            contentCountTv.setText("0/" + maxLength);
    ...
    public void setText(CharSequence value) {
        ...
        if (contentCountTv.getVisibility() == View.VISIBLE) {
            contentCountTv.setText(value.length() + "/" + maxLength);
        }
