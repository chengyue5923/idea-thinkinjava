...
import com.fhzc.app.android.utils.ImageLoaderUtil;
...
public class BubbleImageView extends ImageView {
    ...
    protected int defaultImageRes = R.drawable.im_message_image_default;
        ...
        if (isAttachedOnWindow) {
            ...
            if (!TextUtils.isEmpty(this.imageUrl)) {
                ...
                ImageLoaderUtil.getImageLoaderInstance().displayImage(this.imageUrl, imageAware, new DisplayImageOptions.Builder()
                        .cacheInMemory(true)
                        .cacheOnDisk(true)
                        .showImageOnLoading(R.drawable.im_message_image_default)
                        .showImageOnFail(R.drawable.im_message_image_error)
            ...
            this.setImageResource(R.drawable.im_message_image_default);
        }
    }
